...
let options = {
    ...
    logDetail: process.env.LOG_DETAIL || "warn", // none, error, warn, info, debug
    ...
    connectionRetries: 3,
    floodSleepThreshold: 60, // The most common error is the FloodWait error which is caused by calling a method multiple times in a short period and acts as a spam filter from telegram.
